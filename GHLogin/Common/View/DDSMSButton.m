...
-(void)SMSButtonBlock:(TouchedSMSButtonButtonBlock)touchedSMSButtonButtonBlock{
    _touchedSMSButtonBlock = [touchedSMSButtonButtonBlock copy];
    [self addTarget:self action:@selector(touched:) forControlEvents:UIControlEventTouchUpInside];
}

-(void)touched:(DDSMSButton *)sender{
    if (_touchedSMSButtonBlock) {
        _touchedSMSButtonBlock(sender,sender.tag);
    }
}
